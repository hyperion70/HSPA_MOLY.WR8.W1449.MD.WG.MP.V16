...
typedef enum
{
  ...
  ,RF_TEST_CMD_GET_BBTXCFG6
    ...
    ,RF_TEST_CMD_MULTISLOT_TX_WITH_AUXADC_READ
    ,RF_TEST_CMD_GAIN_RF_TX                    /**< \brief EDGE TX gain rf cal */
    ,RF_TEST_CMD_QUERY_GAIN_RF_NUM             /**< \brief Query gain rf target support number (max: 20)*/
    ,RF_TEST_CMD_GET_BB_POWER_LIST             /**< \brief Get BB power list from target */
    ,RF_TEST_CMD_END
} RfTestCmdType;
...
typedef union
{
   ...
   /// META_Rf_QueryNumOfGainRf_r output
   kal_uint8                     m_ucNumOfGainRf;
   /// META_Rf_QueryBBPowerList_r output
   kal_int16                     m_sBBPowerArrary[20];
} RfTestResultParam;
