...
#ifndef _RATDM_EVENT_INFO_TRC_H
#define _RATDM_EVENT_INFO_TRC_H
...
//#include "event_info_utility.h"
    ...
    #include "ratdm_event_info_trc_gen.h"
#endif /* TST Trace Defintion */
#endif
BEGIN_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1401, 1500)
/***************************************************************************
...
/***************************** Beging of Protocol Action  **************************/
   ...
   TRC_MSG(EVENT_INFO_GROUP3_GOTTEN_HSUPA_RES, "[UE_GOTTEN_UPA_FROM_RATDM]UPA state on")
   TRC_MSG(EVENT_INFO_GROUP3_NOT_GOTTEN_HSUPA_RES, "[UE_GOTTEN_UPA_FROM_RATDM]UPA state off")
#endif
#else
   /*Level 1 put here*/
   /*Level 2 put here*/
...
END_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1401, 1500)
#endif
