...
#ifndef _UL1_EVENT_INFO_TRC_H
#define _UL1_EVENT_INFO_TRC_H
...
#endif
BEGIN_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1, 100)
/***************************************************************************
...
#ifdef __GEMINI__
   /*Level 1 put here*/
   TRC_MSG(EVENT_INFO_GROUP1_UMTS_RLF, "%Msim_interface_enum, UMTS Radio Link Failure")
   
   /*Level 2 put here*/
   /*Level 3 put here*/
#else
   /*Level 1 put here*/
   TRC_MSG(EVENT_INFO_GROUP1_UMTS_RLF, "UMTS Radio Link Failure")
...
#ifdef __GEMINI__
   TRC_MSG(EVENT_INFO_TRACE_WARNING_PACKET_ACCESS_FAILURE, "%Msim_interface_enum, [Packet Access Fail] : Cause = %d")
#else
   TRC_MSG(EVENT_INFO_TRACE_WARNING_PACKET_ACCESS_FAILURE, "[Packet Access Fail] : Cause = %d")
#endif
...
#ifdef __GEMINI__
   TRC_MSG(EVENT_INFO_TRACE_WARNING_TDD_RATCM_gets_LBM_msg, "%Msim_interface_enum, [RATCM] gets LBM message")
#else
   TRC_MSG(EVENT_INFO_TRACE_WARNING_TDD_RATCM_gets_LBM_msg, "[RATCM] gets LBM message")
#endif
...
/***************************** Beging of L1 EVENT INFO  ***************************************/
   TRC_MSG(EVENT_INFO_TRACE_INFO_UL1D_RARE_FT_EVENT,  "[UL1D] event id=%u, group=%u, record flag=0x%08X")
   TRC_MSG(EVENT_INFO_TRACE_INFO_UL1AC_RARE_FT_EVENT, "[UL1AC] event id=%u, group=%u, record flag=0x%08X")
/***************************** End of L1 EVENT INFO  ******************************************/

END_TRACE_MAP_WITH_RANGE(MOD_EVENT_INFO, 1, 100)
#endif
