 ...
 * While EXT_ASSERT_DUMP() ASSERT_SPECIFIC() EXT_ASSERT_SPECIFIC() are auxility  
 */
...
#define EXT_ASSERT_SPECIFIC(expr, e1, e2, e3, key, ...) do {if(!(expr)) kal_assert_fail_specific(__LINE__, e1, e2, e3, key, __VA_ARGS__); } while (0)
