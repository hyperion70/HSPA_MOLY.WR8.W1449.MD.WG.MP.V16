...
#****************************************************************************
my $VERNO     = " m0.03";
             # m0.03 , 2014/01/15,  Support GetPhysicalDummyEndOffset()
...
sub GetPhysicalDummyEndOffset
{
    my ($MAKEFILE_PATH, $IMAGELAYOUT_PATH, $LISorMAP_PATH, $SYM_PATH, $PrintFunc) = @_;
    Parse(FILEOPTION::SYM, $SYM_PATH);
    my $strDummyEnd = &LinkerOutputParser::Get_DUMMY_END_Base();
    my $nOffset = hex($strDummyEnd) & 0x0FFFFFFF;
    return CommonUtil::Dec2Hex($nOffset);
}
