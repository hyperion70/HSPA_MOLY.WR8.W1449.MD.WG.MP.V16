...
# Global variable
#****************************************************************************
my @Supported_Cmd = qw(-h help --help tcmmargin symintcm comparetcm objintcm rammargin objinfo libinfo 
                                      compareobj comparelib  basicinfo diff2symin diffsymin symin
                                      comparediscard discard );
my $g_bToLog = 0;
#****************************************************************************
# MainFlow
#****************************************************************************
unlink $LOG_PATH if(-e $LOG_PATH);
PrintLog("Command: tools/MemoryUtility/main.pl $ARGV[0] $ARGV[1] $ARGV[2] $ARGV[3] $ARGV[4] $ARGV[5]\n\n");
