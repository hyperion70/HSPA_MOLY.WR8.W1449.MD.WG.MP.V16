...
/*
* FUNCTION
*	MT6306_getDeviceAddr
*
* DESCRIPTION
*   	This function is to get the MT6306 device address
*	There is some pin, can be configured by schematic, of MT6306 to set it address value.
*	The MT6306 device only listen to the I2C command to its adress.
*
* CALLS
*
* PARAMETERS
