...
//  Restriction:    The two defined values below must be the same address
/******************************************************************************/

#define VENDOR_MAC_ADDRESS_PREFIX           0x02,0x00,0xFF

#define VENDOR_ECM_MP_MAC_ADDRESS_FOR_USB   \
    '0','2','0','0','F','F','A','A','A','A','A','A'

// Internal use
#define VENDOR_ECM_MP_MAC_ADDRESS           0x02,0x00,0xFF,0xAA,0xAA,0xAA
