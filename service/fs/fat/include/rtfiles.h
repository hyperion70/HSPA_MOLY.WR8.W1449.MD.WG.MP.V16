...
/*------------- Internal EXTERN -------------*/
#define ParseFileName(FileName) ParseFileName1((const char *)FileName, 0)
...
extern RTFDOSDirEntry *StartDirSearch(RTFDrive * Drive, RTFCluster Cluster, UINT Index, RTFDirLocation * DSR);
...
extern int IncDir(RTFDrive * Drive, RTFDirLocation * DSR);
...
#define GetClusterValue(a, b)   fs_srv_get_cluster_value(a, b, FS_GET_CLUSTER_DEFAULT, GetBuffer)
