...
typedef U32 (*SD_XBOOTCMD_STATUS_V1)(Xboot_CMD_Handle *handle, XBOOT_CMD_ID msg_id, XBOOT_STAUS status);
typedef U32 (*SD_XBOOTCMD_GETBIN_V1)(Xboot_CMD_Handle *handle, U32 offset, U32 len, U32 dest_addr);
typedef U32 (*SD_XBOOTCMD_DBGPRINT_V1)(Xboot_CMD_Handle *handle, const char *str, U32 len);
