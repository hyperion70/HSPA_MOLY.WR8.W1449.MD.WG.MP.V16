...
typedef struct Xboot_CMD_Handle {
    U32                m_timeout;
    FUNC_IO_DATA       send_data;
    FUNC_IO_DATA       get_data;
...
// function prototype
//==============================================================================
extern U32 XbootCmd_Status(Xboot_CMD_Handle *handle, XBOOT_CMD_ID msg_id, XBOOT_STAUS status);
extern U32 XbootCmd_GetBin(Xboot_CMD_Handle *handle, U32 offset, U32 len, U32 dest_addr);
extern U32 XbootCmd_DbgPrint(Xboot_CMD_Handle *handle, const char *str, U32 len);
