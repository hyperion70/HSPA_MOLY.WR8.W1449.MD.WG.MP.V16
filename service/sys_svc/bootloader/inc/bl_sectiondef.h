...
#define __emiinitcode__                __attribute__ ((section("EMIINITCODE")))
#define __emiinitrw__                  __attribute__ ((section("EMIINITRW")))
#define __emiinitzi__                  __attribute__ ((section("EMIINITZI"))) __zero_init__
