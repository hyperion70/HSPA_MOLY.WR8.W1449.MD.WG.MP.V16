 ...
 * Description:
 * ------------
 *   This file contains the prototype for the function 
 *   called at sublayer initialization.
 *
 * Author:
 * -------
 * -------
...
#ifndef _SMSAL_INIT_H
#define _SMSAL_INIT_H

#include "kal_general_types.h"

/* This function initialize all the context variables
 * required for SMSAL layer */
kal_bool smsal_init(void);
