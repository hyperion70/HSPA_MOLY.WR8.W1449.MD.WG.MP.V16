...
extern void l4cuem_audio_get_volume_req(kal_uint8 src_id, kal_uint8 volume_type);
...
extern kal_bool l4cuem_rtc_set_time_req(kal_uint8 rtc_type, rtc_alarm_info_struct rtctime, kal_uint8 setting_type);
...
extern void l4cuem_speech_set_mode_req(kal_bool speech_mode_onoff, kal_uint8 rat_mode);
...
extern void l4cuem_get_audio_profile_req(kal_uint8 src_id, kal_uint8 mode);

extern void l4cuem_get_audio_param_req(kal_uint8 src_id);

#if defined(__AMRWB_LINK_SUPPORT__)
extern void l4cuem_get_aduio_wb_param_req(kal_uint8 src_id, l4_wb_audio_para_action_enum option);

extern void l4cuem_set_aduio_wb_param_req(kal_uint8 src_id, l4_wb_audio_para_action_enum option, void *new_param);
#endif
...
/* under construction !*/
#endif
extern void l4cuem_lcd_set_contrast_req(kal_uint8 lcd_id, kal_uint8 contrastlevel);
