...
extern void ueml4c_get_audio_wb_param_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern void ueml4c_set_audio_wb_param_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
#endif
...
extern void uemdrv_rf_test_gsm_powerscan_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern void uemdrv_ccci_em_req_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
