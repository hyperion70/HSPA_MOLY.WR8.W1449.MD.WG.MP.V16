 ...
 * Description:
 * ------------
 *   This is declarations of delete ln handler.
 *
 * Author:
 * -------
 * -------
...
#ifndef _PHB_HANDLER_DELETE_LN_H_
#define _PHB_HANDLER_DELETE_LN_H_
...
extern "C"
{
    ...
    typedef enum
    {
        DEL_SIM_LN_NONE,
        DEL_SIM_LN_WRITE
    } delete_sim_ln_stage_enum;
    extern void phb_delete_sim_ln_handler(ilm_struct *ilm_ptr, control_block_type *control_block);
