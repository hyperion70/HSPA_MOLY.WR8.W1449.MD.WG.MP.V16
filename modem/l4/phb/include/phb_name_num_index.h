 ...
 */
    ...
    extern kal_uint16 phb_name_num_index_find_index_by_num_sig(
                        ...
                        kal_uint8 signature,
                        kal_uint8 tel_num);
    extern kal_uint16 phb_name_num_index_find_index_by_num_sig_for_wild_char(
            name_num_index_type *name_num_index,
            kal_uint8 signature,
            kal_uint8 tel_num);
    extern kal_uint16 phb_name_num_index_find_index_one_by_one_for_wild_char(
    ...
    extern void phb_compare_by_tel_num_sig_for_sort(
                    ...
                    pindex_struct *second_pos,
                    compare_result_type *result);
    extern void phb_compare_by_tel_num_sig_for_sort_for_wild_char(
                    data_entry_table_type *external_data,
                    pindex_struct *first_pos,
                    pindex_struct *second_pos,
                    compare_result_type *result);
