 ...
 * Description:
 * ------------
 *   This is declarations of write ln handler.
 *
 * Author:
 * -------
 * -------
 ...
 *==============================================================================
 *******************************************************************************/
#ifndef _PHB_HANDLER_WRITE_LN_H_
#define _PHB_HANDLER_WRITE_LN_H_
...
extern "C"
{
    ...
    typedef enum
    {
        WRITE_SIM_LN_NONE,
        WRITE_SIM_LN_WRITE
    } write_sim_ln_stage_enum;

    extern void phb_write_sim_ln_handler(ilm_struct *ilm_ptr, control_block_type *control_block);
#endif /* __PHB_ACCESS_SIM_LN__ */
#ifdef __cplusplus
}
#endif 

#endif /* #define _PHB_HANDLER_WRITE_LN_H_ */ 
