...
typedef struct {
    LOCAL_PARA_HDR
    kal_uint8 scan_id;
    kal_uint16 arfcn_scanned_list_len;
    kal_uint16 arfcn[200]; /* depend on the mph_cs_msg.h, mphc_power_scan_cnf_struct */
    kal_int16 power_sum_in_quarter_dbm[200]; /* depend on the mph_cs_msg.h, mphc_power_scan_cnf_struct */
