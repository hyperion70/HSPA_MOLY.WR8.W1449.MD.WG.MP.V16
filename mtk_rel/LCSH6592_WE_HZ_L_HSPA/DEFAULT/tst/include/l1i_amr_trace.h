...
#endif
#define L1I_Trc_AMR_Channel_Decoder_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x000B, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (char)(v3), TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_Channel_Encoder_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x010B, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_Speech_Decoder_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x020B, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_Speech_Encoder_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x030B, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_Codec_Err_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x040B, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_CC_TX_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x050B, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_Config_Flag_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_4_DATA(TRC_MERGE_2S(0x060B, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_4C((char)(v6), (char)(v7), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_INB_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x070B, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_INB_Corr_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x080B, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_INB_Debug_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x090B, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_FACCH_RATSCCH_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A0B, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define L1I_Trc_AMR_IM_SID_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0B0B, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define L1I_Trc_AMR_Config_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x0C0B, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), (char)(v5), (char)(v6)), TRC_MERGE_4C((char)(v7), (char)(v8), (char)(v9), (char)(v10)), TRC_MERGE_4C((char)(v11), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_DSP_Threshold_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0D0B, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
...
#endif
#define L1I_Trc_AMR_DSP_ICM_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0E0B, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_DSP_ACS_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0F0B, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_DSP_CMR_Enable_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x100B, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define L1I_Trc_AMR_DSP_CI_Compen_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x110B, (short)(v1)))
...
#endif
#define L1I_Trc_AMR_Speech_Info_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x120B, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Trc_AMR_Debug_Info1_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_4_DATA(TRC_MERGE_2S(0x130B, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)))
...
#endif
#define L1I_Trc_AMR_Debug_Info2_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_4_DATA(TRC_MERGE_2S(0x140B, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)))
