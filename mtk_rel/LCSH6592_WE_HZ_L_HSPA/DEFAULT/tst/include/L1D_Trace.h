...
#endif
#define L1D_Trc_DPTCHS0FLAGS_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0006, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DPCCFLAG_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0106, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define L1D_Trc_DPNB_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0206, (char)(v1), (unsigned char)(v2)))
...
#endif
#define L1D_Trc_DPGSMMODE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0306, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DPTXWIN0PROC_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0406, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DPRXWIN0PROC_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0506, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_SHARED2MCTL_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0806, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_SetChannelCmd_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0906, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define L1D_Trc_ReportPeriod_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A06, (char)(v1), (char)(v2)))
...
#endif
#define L1D_Trc_FCChStage_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0B06, (char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_CipherCmd_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C06, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define L1D_Trc_CipherKey_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0D06, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_1S2C((unsigned short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_PDNCON2_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0E06, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_BCCR_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0F06, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_EVENA1_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1006, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_USF_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1106, (short)(v2)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v1), (char)(v3)))
...
#endif
#define L1D_Trc_APC_VOLTTEMP_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1206, (char)(v1), TRC_BOXSTER_PAD), (long)(v2), (long)(v3))
...
#endif
#define L1D_Trc_CCH_UL_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1306, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_CCH_UL_DATA_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1406, (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_MaxTime_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1506, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DurMargin_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x1606, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1_Trace_sm1_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1706, (unsigned short)(v2)), (unsigned long)(v1))
...
#endif
#define L1_Trace_sm2_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1806, (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1_Trace_sm3_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1906, (unsigned short)(v2)), TRC_MERGE_2S((unsigned short)(v3), (short)(v5)), TRC_MERGE_1S2C((short)(v6), (unsigned char)(v1), (unsigned char)(v4)))
...
#endif
#define L1_Trace_sm4_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1A06, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#endif
#define L1_Trace_sm5_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_2S(0x1B06, (short)(v3)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v4), (unsigned long)(v5))
...
#endif
#define L1D_Trace_FMResult_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1C06, (unsigned char)(v1), (unsigned char)(v2)), (unsigned long)(v3), (unsigned long)(v4))
...
#endif
#define L1D_AGPS_LCT_COUNTING_NOFLTR(v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x1D06, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
...
#endif
#define L1D_AGPS_REPORT_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1E06, (unsigned char)(v1), (char)(v2)), (unsigned long)(v3), (unsigned long)(v4))
...
#endif
#define L1D_AGPS_FRC_PARAM_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1F06, (char)(v2), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v3))
