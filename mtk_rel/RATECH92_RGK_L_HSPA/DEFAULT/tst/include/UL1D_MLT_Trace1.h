...
#endif
#define UL1D_TRC_MLT_ON_OFF_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x000E, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define UL1D_TRC_MLT_FILTER_SETTING_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x010E, (unsigned short)(v1)))
...
#endif
#define UL1D_TRC_MLT_TXCRP_DEFAULT_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x020E, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))
...
#endif
#define UL1D_TRC_MLT_ULPC_RPP_ITP_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x030E, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define UL1D_TRC_MLT_TXBRP_MAX_TTI_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x050E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define UL1D_TRC_MLT_TXCRP_TG_METHOD_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x060E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define UL1D_TRC_MLT_TXCRP_CFN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x070E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define UL1D_TRC_MLT_TXCRP_MSG_STSP_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x080E, (unsigned short)(v1)))
...
#endif
#define UL1D_TRC_MLT_TXCRP_PRE_STSP_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x090E, (unsigned short)(v1)))
...
#endif
#define UL1D_TRC_MLT_TXCRP_MSGD_SFCC_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0A0E, (unsigned short)(v1)))
...
#endif
#define UL1D_TRC_MLT_TXCRP_MSGC_SFCC_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0B0E, (unsigned short)(v1)))
...
#endif
#define UL1D_TRC_MLT_TXCRP_PRE_SFCC_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0C0E, (unsigned short)(v1)))
...
#endif
#define UL1D_TRC_MLT_TM_ST_STROBE_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0D0E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#endif
#define UL1D_TRC_MLT_TM_CS4_STROBE_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0E0E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#endif
#define UL1D_TRC_MLT_TM_DD_STROBE_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F0E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#endif
#define UL1D_TRC_MLT_CS_EST_BIN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x100E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define UL1D_TRC_MLT_RFM_S_RLID2PSC_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x110E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define UL1D_TRC_MLT_RFM_N_RLID2PSC_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x120E, (unsigned short)(v1)))
...
#endif
#define UL1D_TRC_MLT_RFM_S_ST0_SYM_IDX_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x130E, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)))
...
#endif
#define UL1D_TRC_MLT_RFM_N_ST0_SYM_IDX_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x140E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define UL1D_TRC_AGPS_IMPORTAN_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x150E, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#endif
#define UL1D_TRC_AGPS_REPORT_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x160E, (char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))
...
#endif
#define UL1D_TRC_AGPS_FRC_PARAM_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x170E, (char)(v1), (char)(v3)), (unsigned long)(v2), (unsigned long)(v4))
...
#endif
#define UL1D_TRC_DCH_ASU_CHECK_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x180E, (unsigned short)(v3)), (long)(v1), (long)(v2))
