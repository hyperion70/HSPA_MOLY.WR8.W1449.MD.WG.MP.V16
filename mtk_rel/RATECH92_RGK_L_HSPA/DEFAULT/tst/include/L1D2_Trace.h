...
#endif
#define L1I_Msg_AFC_Assert_Reason_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0007, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1I_Msg_AFC_TQ_TIME_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0107, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Msg_AFC_Assert34_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0207, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1I_Msg_AFC_Tid_MisMatch_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0307, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_SB_Status_Extend_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) TRC_SEND_5_DATA(TRC_MERGE_2S(0x0407, (short)(v2)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v7), (short)(v8)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), (char)(v6), (unsigned char)(v9)), TRC_MERGE_4C((unsigned char)(v10), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_SP_flag_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0607, (short)(v1)))
...
#endif
#define L1D_SP_flag_Fsig_no_data_tx_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0707, (short)(v1)))
...
#endif
#define L1I_DCM_status_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0807, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_PCH_OK_AT_STATE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0907, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_CCCH_OK_AT_STATE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0A07, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_PCH_One_Burst_Enable_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B07, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_PCH_Null_Detect_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C07, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_PCH_Empty_Detect_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D07, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_PCH_Pattern_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0E07, (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)), TRC_MERGE_1S2C((unsigned short)(v8), (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define L1D_TRC_PM_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F07, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DP6TapEQStatus_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1007, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_DSP_WATCH_DOG_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1107, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_DSP_RX_FILTER_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1207, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_CD2nd_CRC_Pass_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1307, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_Tx_ARFCN_TA_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1407, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_Timing_Check_Fail_v1_NOFLTR(v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1507, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#endif
#define L1D_Trc_Timing_Check_Fail_v2_NOFLTR(v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x1607, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
...
#endif
#define L1D_Trc_Execute_Timing_Check_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1707, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DSP_PM_Not_Done_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1807, (unsigned short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#endif
#define L1D_Trc_AFC_DAC_Data_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1907, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_MPLL_FH_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_7_DATA(TRC_MERGE_2S(0x1A07, (short)(v2)), TRC_MERGE_1S2C((short)(v7), (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v8))
...
#endif
#define L1D_Trc_LCD_Collision_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1B07, (short)(v4)), TRC_MERGE_2S((short)(v5), (short)(v6)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_FCCh_Start_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1C07, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v4))
...
#endif
#define L1D_Trc_FCCh_Stop_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1D07, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), (char)(v4)))
...
#endif
#define L1D_Trc_FB_False_Alarm_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1E07, (short)(v2)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), (unsigned char)(v1), (char)(v3)))
...
#endif
#define L1D_Trc_TXPC_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1F07, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
