...
#endif
#define URLC_TRC_GETBO_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0021, (char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_SELECT_SUFI_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0221, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_SCHEDULE_ACK_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0321, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_TRANSMIT_AM_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0421, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_TRANSMIT_UM_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0521, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_TRANSMIT_TM_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0621, (char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_TRANSMIT_AM_SN_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0721, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define URLC_TRC_RETRANSMIT_AM_SN_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0821, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define URLC_TRC_TRANSMIT_AM_CTRL_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0921, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_TRANSMIT_UM_SN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A21, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_NOTIFY_SETUP_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0C21, (unsigned short)(v1)))
...
#endif
#define URLC_TRC_NOTIFY_RELEASE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0D21, (unsigned short)(v1)))
...
#endif
#define URLC_TRC_ACTIVATE_TX_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0E21, (unsigned short)(v1)), TRC_MERGE_4C((char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_ACTIVATE_TX_RES_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0F21, (unsigned short)(v1)), TRC_MERGE_4C((char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_ZERO_CTRL_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1021, (short)(v1)))
