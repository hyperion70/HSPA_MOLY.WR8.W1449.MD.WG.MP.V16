...
#endif
#define XO_TRACE_VTuneCrt7AREA_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x000E, (short)(v3)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v2), (long)(v4))
...
#endif
#define XO_TRACE_FreqCrtUpdate_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x010E, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define XO_TRACE_ReadTempADC_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x020E, (short)(v1)), (long)(v2))
...
#endif
#define XO_TRACE_CmpTempPhi_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x030E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
...
#endif
#define XO_TRACE_Phi2Dac_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x040E, (short)(v2)), (long)(v1))
...
#endif
#define CH_afc_dbg_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x050E, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3), (long)(v4))
...
#endif
#define CH_afc_dbg2_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x060E, (short)(v2)), (long)(v1), (long)(v3), (long)(v4))
...
#endif
#define CH_afc_dbg3_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x070E, (short)(v1)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v2), (long)(v3))
...
#endif
#define CH_afc_dbg4_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x080E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)))
...
#endif
#define CH_afc_dbg5_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x090E, (short)(v1)))
...
#endif
#define L1D_Trc_DUAL_AFC_L1C_ask_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A0E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DUAL_AFC_DAC_Sharing_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B0E, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DUAL_AFC_MODE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C0E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trace_TM_Sync_State_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D0E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_TDDM_FCCH_1_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0E0E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), (long)(v4), (long)(v5))
...
#endif
#define L1D_TDDM_FB_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0F0E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#endif
#define L1D_TDDM_SetGap_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x100E, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_TDDM_FBM_SHORT_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x110E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_TDDM_SBM_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x120E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_TDDM_PM_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x130E, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_TDDM_STATE_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x140E, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define L1D_TDDM_AFC_CON_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x150E, (short)(v1)))
...
#endif
#define L1D_Trc_RepeatedACCH_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x160E, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), (unsigned char)(v5), (char)(v6)))
...
#endif
#define L1D_TRC_DEBUG_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x170E, (unsigned short)(v1)), (long)(v2), (long)(v3))
...
#endif
#define L1D_DTS_TRACE_MACHINE_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x180E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#endif
#define L1D_TRC_NonSync_HO_Event_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x190E, (unsigned char)(v1), (char)(v2)))
...
#endif
#define L1D_Trc_WGG_Event_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1A0E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_WGG_ConsumePMQueue_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1B0E, (short)(v1)))
...
#endif
#define L1D_Trc_WCAL_RESULT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1C0E, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_HRD_POWER_RESULT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1D0E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#endif
#define L1D_Trc_HRD_RESULT_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1E0E, (char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_VAMOS_RESULT_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1F0E, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_1S2C((short)(v5), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_BLK_RESULT_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x200E, (short)(v1)))
...
#endif
#define L1D_Trc_DLIF_SWITCH_IF_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x210E, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DLIF_PEER_IF_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x220E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define L1D_Trc_DLIF_RETURN_IF_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_4_DATA(TRC_MERGE_2S(0x230E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v6), (short)(v7)))
