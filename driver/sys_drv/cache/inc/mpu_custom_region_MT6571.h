...
/* [align to MT6582/MT6592] Access to this address will cause bus hang. This is the last channel of MPU, for test, you can use this one. */
X_MPU_INIT_REGION(    AP_MD_SLT_SYNC,  0x01D00000,     0x00080000,  MPU_PRW_URW | MPU_XN | MPU_DEVICE_INS_OUTDEV,  1       )
#endif
