 ...
 * Description:
 * ------------
 *   This Module defines PDN HW registers for MT6571 series chips.
 *
 * Author:
 * -------
 * -------
...
#ifndef __PDN_HW_MT6571_SERIES_H__
#define __PDN_HW_MT6571_SERIES_H__
...
/* AP sys */
#define DRVPDN_AP_CLK_GATING_CTRL1      (AP_TOP_CLOCK_CTRL_BASE+0x0024)
#define DRVPDN_AP_SET_CLK_GATING_CTRL1  (AP_TOP_CLOCK_CTRL_BASE+0x0050)
#define DRVPDN_AP_CLR_CLK_GATING_CTRL1  (AP_TOP_CLOCK_CTRL_BASE+0x0084)
#define DRVPDN_AP_CLK_GATING_USB_SW_CG  (1<<13)

#endif  /* !__PDN_HW_MT6571_SERIES_H__ */
