 ...
 * Description:
 * ------------
 *   This Module defines PDN HW registers for MT6572 series chips.
 *
 * Author:
 * -------
 * -------
...
#ifndef __PDN_HW_MT6572_SERIES_H__
#define __PDN_HW_MT6572_SERIES_H__
...
#define DRVPDN_MD_GLOBAL_CON0  (CONFIG_base+0x0450)

#define DRVPDN_MD_GLOBAL_SET0  (CONFIG_base+0x0454)

#define DRVPDN_MD_GLOBAL_CLR0  (CONFIG_base+0x0458)

#define MD_GLOBAL_CON0_DMA             0x00000001
#define MD_GLOBAL_CON0_BOOT_SLV        0x00000002
#define MD_GLOBAL_CON0_ABM             0x00000004
#define MD_GLOBAL_CON0_ADOE            0x00000008
#define MD_GLOBAL_CON0_UART            0x00000010
#define MD_GLOBAL_CON0_DBG             0x00000020
#define MD_GLOBAL_CON0_OSTIMER         0x00000040
#define MD_GLOBAL_CON0_GPT             0x00000080
#define MD_GLOBAL_CON0_TOPSM           0x00000100
#define MD_GLOBAL_CON0_DCM_MON         0x00000200
#define MD_GLOBAL_CON0_SIM1            0x00000400
#define MD_GLOBAL_CON0_SIM2            0x00000800
#define MD_GLOBAL_CON0_ELM             0x00010000
#define MD_GLOBAL_CON0_ALC             0x00020000
#define MD_GLOBAL_CON0_PF_BUFF         0x00040000
...
/* AP sys */
#if defined(MT6572)
# define DRVPDN_AP_CKGEN_CG_CON1        (AP_TOP_CLOCK_CTRL_BASE+0x0024)
# define DRVPDN_AP_CKGEN_CG_SET1        (AP_TOP_CLOCK_CTRL_BASE+0x0054)
# define DRVPDN_AP_CKGEN_CG_CLR1        (AP_TOP_CLOCK_CTRL_BASE+0x0084)

# define AP_CKGEN_CG_CON1_USB           (1<<13)
# define AP_CKGEN_CG_CON1_PMIC_26M      (1<<29)
# define AP_CKGEN_CG_CON1_PMIC_CONN     (1<<28)
# define AP_CKGEN_CG_CON1_PMIC_MD       (1<<27)
# define AP_CKGEN_CG_CON1_PMIC_AP       (1<<20)
#elif defined(MT6582) || defined(MT6592)
# define DRVPDN_AP_CKGEN_CLK_CFG2       (AP_TOP_CLOCK_CTRL_BASE+0x0060)
# define AP_CKGEN_CLK_CFG2_USB          (1<<23)
#endif
...
#endif  /* !__PDN_HW_MT6572_SERIES_H__ */
