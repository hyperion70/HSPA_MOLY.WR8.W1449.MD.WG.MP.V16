 ...
 * Description:
 * ------------
 *   This file defines PDN X-MACRO for MT6572 series chips.
 *
 * Author:
 * -------
 * -------
...
#if defined(MT6572)
X_PDN_CONST(USB, DRVPDN_AP_CKGEN_CG_CON1, DRVPDN_AP_CKGEN_CG_SET1, DRVPDN_AP_CKGEN_CG_CLR1, AP_CKGEN_CG_CON1_USB, PDN_OPT_32BIT_REG)
X_PDN_CONST(PMIC_26M, DRVPDN_AP_CKGEN_CG_CON1, DRVPDN_AP_CKGEN_CG_SET1, DRVPDN_AP_CKGEN_CG_CLR1, AP_CKGEN_CG_CON1_PMIC_26M, PDN_OPT_32BIT_REG)
X_PDN_CONST(PMIC_CONN, DRVPDN_AP_CKGEN_CG_CON1, DRVPDN_AP_CKGEN_CG_SET1, DRVPDN_AP_CKGEN_CG_CLR1, AP_CKGEN_CG_CON1_PMIC_CONN, PDN_OPT_32BIT_REG)
X_PDN_CONST(PMIC_MD, DRVPDN_AP_CKGEN_CG_CON1, DRVPDN_AP_CKGEN_CG_SET1, DRVPDN_AP_CKGEN_CG_CLR1, AP_CKGEN_CG_CON1_PMIC_MD, PDN_OPT_32BIT_REG)
X_PDN_CONST(PMIC_AP, DRVPDN_AP_CKGEN_CG_CON1, DRVPDN_AP_CKGEN_CG_SET1, DRVPDN_AP_CKGEN_CG_CLR1, AP_CKGEN_CG_CON1_PMIC_AP, PDN_OPT_32BIT_REG)
#elif defined(MT6582) || defined (MT6592)
X_PDN_CONST(USB, DRVPDN_AP_CKGEN_CLK_CFG2,  DUMMY_PDN_SET_REGISTER, DUMMY_PDN_CLR_REGISTER, AP_CKGEN_CLK_CFG2_USB, PDN_OPT_32BIT_REG)
#endif
...
//X_PDN_CONST(PFC, DRVPDN_MD_GLOBAL_CON0, DRVPDN_MD_GLOBAL_SET0, DRVPDN_MD_GLOBAL_CLR0, MD_GLOBAL_CON0_PFC, PDN_OPT_32BIT_REG)
...
//X_PDN_CONST(SFC, DRVPDN_MD_GLOBAL_CON0, DRVPDN_MD_GLOBAL_SET0, DRVPDN_MD_GLOBAL_CLR0, MD_GLOBAL_CON0_SFC, PDN_OPT_32BIT_REG)
//X_PDN_CONST(TRACE, DRVPDN_MD_GLOBAL_CON0, DRVPDN_MD_GLOBAL_SET0, DRVPDN_MD_GLOBAL_CLR0, MD_GLOBAL_CON0_TRACE, PDN_OPT_32BIT_REG)
//X_PDN_CONST(LMU, DRVPDN_MD_GLOBAL_CON0, DRVPDN_MD_GLOBAL_SET0, DRVPDN_MD_GLOBAL_CLR0, MD_GLOBAL_CON0_LMU, PDN_OPT_32BIT_REG)
...
//X_PDN_CONST(TIU_BUFF, DRVPDN_MD_GLOBAL_CON0, DRVPDN_MD_GLOBAL_SET0, DRVPDN_MD_GLOBAL_CLR0, MD_GLOBAL_CON0_TIU_BUFF, PDN_OPT_32BIT_REG)
