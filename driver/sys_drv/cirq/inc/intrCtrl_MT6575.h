...
#define IRQ_CINT_2_CODE            (67) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_CINT_3_CODE            (68) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_CINT_4_CODE            (69) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_CINT_5_CODE            (70) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_CINT_6_CODE            (71) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_CINT_7_CODE            (72) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_NFI_CODE               (73) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_SW_LISR1_CODE          (74) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_SW_LISR2_CODE          (75) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_SW_LISR3_CODE          (76) /* Reference to MT6575 Interrupt Investigate.xlsx */
#define IRQ_SW_LISR4_CODE          (77)
#define IRQ_SW_LISR5_CODE          (78)
#define IRQ_SW_LISR6_CODE          (79)
#define NUM_IRQ_SOURCES            (80) /* Reference to MT6575 Interrupt Investigate.xlsx */
