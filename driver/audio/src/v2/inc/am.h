...
void     AM_AudioPlaybackOn_Initialize( kal_uint32 channel, kal_uint32 freqIndex, kal_uint32 fc_aud_id );
void     AM_AudioPlaybackOn_V2( kal_uint32 channel, kal_uint32 freqIndex, MHdl *hdl );
void     AM_AudioPlaybackOff_V2( bool wait );

void     Media_A2V_AddFirstFrameInterruptDelay_v2(kal_uint32 uSampleRate, kal_uint8 uChannelNum);
