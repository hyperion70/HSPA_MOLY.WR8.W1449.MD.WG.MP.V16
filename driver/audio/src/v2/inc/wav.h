...
#define  FRAME_BUF_SIZE_16K_ST   640
...
struct wav_Struct{
 ...
 /*workaround for SPEECH DSP MAIN/AUX Mode Task in FCORE*/ 
   ...
   kal_uint32          dropFrame;//in the beginning of turnning on analog AFE, it will cause a pulse. So driver drop 4 frames for 10ms driver delay, 20ms DSP delay, 40ms Pulse
};
