...
static DCL_STATUS DCL_USB_CTRL_API_USB_DMA_Setup(DCL_CTRL_DATA_T *data)
{
    ...
    addr = (kal_uint32)prdma_setup_func->u4addr | 0x80000000;
  #elif defined(MT6572) || defined(MT6582) || defined(MT6571) || defined(MT6592) || defined(MT6580) /*USB in AP side, bank addr is 0x80000000*/
    #if defined(__MT6592_AP_MD__) //For AP+MD catcher log debug for 2G 3G camp on
    addr = (kal_uint32)prdma_setup_func->u4addr | 0x88000000;    
    #else
    addr = (kal_uint32)prdma_setup_func->u4addr | 0x80000000;    
    #endif
  #else
