 ...
 * Description:
 * ------------
 *   This file is merged for MT6252H driver features.
 *
 * Author:
 * -------
 * -------
 ...
 *============================================================================
 ****************************************************************************/
#ifndef DRV_FEATURES_6252H_H
#define DRV_FEATURES_6252H_H
...
/* Features for GPIO */
#if defined(MT6252H_S01)
   #define DRV_GPIO_6253E_SERIES_1
#else //defined(MT6252H_S01)
#define DRV_GPIO_6253E_SERIES
#endif //defined(MT6252H_S01)
