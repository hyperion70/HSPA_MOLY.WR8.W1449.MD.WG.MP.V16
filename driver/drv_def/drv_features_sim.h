...
#if defined(DRV_SIM_6575_SERIES) || defined(DRV_SIM_6256_SERIES) || defined(DRV_SIM_6250_SERIES) || defined(DRV_SIM_6572_SERIES)
...
#if defined(DRV_SIM_6575_SERIES) || defined(DRV_SIM_6256_SERIES) || defined(DRV_SIM_6572_SERIES)
/*76/56/75/73/55 new platform use DMA_Flush, other platform use DMA_Stop */
#define DRV_SIM_DMA_V2
#endif

#if defined(DRV_SIM_6575_SERIES) || defined(DRV_SIM_6572_SERIES)
#define SIM_NAMING_FROM_0_ADDRESS //MT65xx is naming in SIM0, SIM1,..
#endif
...
#if defined(MT6276) || defined(MT6256) || defined(DRV_SIM_6575_SERIES) || defined(MT6255) || defined(MT6250) || defined(DRV_SIM_6256_SERIES) || defined(DRV_SIM_6572_SERIES)
...
#ifdef __CDMA_USE_MTK_BB_PMU__
#define CDMA_USE_MTK_BB_PMU 1
#endif
